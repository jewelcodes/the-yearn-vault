...
export default function MessageEditor(props:any) {
    ...
    return (
        <>
            ...
            <input name="sender" id="sender" maxLength={20} autoComplete="off" placeholder="Optional: From who?" type="text" className="message-sender-input" />
            <div className={c+color}>
                <textarea name="message" id="message" required minLength={5} maxLength={100} placeholder="What do you need to hear?" className="message-text" onKeyDown={preventLineBreak} />
            </div>
            ...
            <div className="color-picker">
                ...
                <div className="color-black" onClick={() => {setColor("message-black")}}></div>
            </div>
        </>
    );
}
