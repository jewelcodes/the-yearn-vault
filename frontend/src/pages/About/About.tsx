...
export default function About() {
    return (
        <section className="sec">
            ...
            <p>The Yearn Vault, much like most of my other projects, is free and open-source software. The source code is available on <a href="https://github.com/jewelcodes/the-yearn-vault">GitHub</a>.</p>
        </section>
    )
}
