    ...
    return (
        <section className="sec">
            ...
            <p>
                ...
                <ul>
                    <li><a target="_blank" href="https://www.patreon.com/TheYearnVault">Patreon</a></li>
                    <li><a target="_blank" href="https://ko-fi.com/theyearnvault">Ko-fi</a></li>
                </ul>
            </p>
            <p>Thank you for considering it! To see more of my projects, take a look at <a target="_blank" href="https://jewelcodes.io/">my blog</a>.</p>
        </section>
    )
}
